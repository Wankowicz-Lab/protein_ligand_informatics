...
def get_files():
    return glob.glob(ROOT_DIR + "/*_modified.pdb")
    ...
    with open(file, "r") as f:
        ...
        for line in lines:
            if line.startswith("ATOM"):
                ...
                decodedLine = parse_pdb_line(line)
                if decodedLine["residue_name"] == "LIG":
...
def create_graph(protein_atoms, ligand_atoms):
    ...
    for i in range(num_atoms):
        print("Processing atom horizontal", i)
...
if __name__ == "__main__":
    testFile = "./PDBs/x2439-pandda-model_refine_001_modified.pdb"
    ...
    thisGraph = create_graph(protein_atoms, ligand_atoms)
    print(thisGraph)